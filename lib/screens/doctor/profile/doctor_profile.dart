...
import 'package:medical_hub/screens/doctor/profile/profile_update_screen.dart';
...
class _DoctorProfileScreenState extends State<DoctorProfileScreen> {
  ...
  void _resetPassword(BuildContext context) async {
    String email = DoctorApis.self.email;
    try {
                          ...
                          builder: (BuildContext context) {
                            return AlertDialog(
                              actions: [
                                TextButton(
                                    onPressed: () async {
                                      await DoctorApis.updateActiveTime(false);
