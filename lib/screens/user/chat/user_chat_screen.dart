        ...
        child: Scaffold(
          body: Container(
            ...
            child: Column(children: [
              ...
              Expanded(
                  child: StreamBuilder(
                stream: ChatApis.getAllMessages(widget.doctor.id),
                  ...
                  IconButton(
                      onPressed: () async {
                        ...
                        for (var image in images) {
                          ...
                          ChatApis.sendChatImage(widget.doctor.id,
                              File(image.path), widget.doctor.isOnline);
                          setState(() {
          ...
          MaterialButton(
            ...
            onPressed: () {
              if (_textEditingController.text.trim().isNotEmpty) {
                DoctorApis.addInboxUsers(widget.doctor);
                ...
                Text(
                  widget.doctor.isOnline
                      ...
                      : MyDateUtil.getLastActiveTime(
                          context: context,
                          lastActive: widget.doctor.lastActive),
